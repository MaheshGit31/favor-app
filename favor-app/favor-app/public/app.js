...
G.hero=function(){
  var s='<svg class="scene" viewBox="0 0 560 560" role="img" aria-label="Illustration: neighbors helping each other outside two houses, with a speaker, a ladder and a microphone"><defs><clipPath id="sc"><rect x="2" y="2" width="556" height="556" rx="40"/></clipPath></defs>';
  s+='<rect class="f-alt" x="2" y="2" width="556" height="556" rx="40"/><g clip-path="url(#sc)">';
  s+='<g class="px1">'+G.sun(452,104,44)+'</g>';
  s+='<g class="px2">'+G.cloud(212,52,1,"drift")+G.cloud(330,168,.7,"drift b")+'</g>';
  s+='<g class="o nf" style="stroke-width:3.5"><g class="flap" style="animation-delay:.1s"><path d="M120 92q8-10 16 0q8-10 16 0"/></g><g class="flap" style="animation-delay:.25s"><path d="M158 74q6-8 12 0q6-8 12 0"/></g></g>';
  /* hills */
  s+='<path class="o f-sprout" d="M-10 352C90 300 200 312 290 342C380 372 470 322 570 330L570 570L-10 570Z"/>';
  /* house A */
  s+='<rect class="o f-sage" x="112" y="268" width="16" height="34"/><rect class="o f-blush" x="34" y="300" width="112" height="100"/><polygon class="o f-clay" points="22,302 90,244 158,302"/><rect class="o f-brand" x="98" y="342" width="26" height="58" rx="3"/><rect class="o f-sun" x="50" y="320" width="26" height="26" rx="3"/><path class="o nf" d="M63 320v26M50 333h26"/>';
  /* house B */
  s+='<rect class="o f-sage" x="410" y="298" width="112" height="102"/><polygon class="o f-brand" points="398,300 466,238 534,300"/><rect class="o f-clay" x="424" y="340" width="26" height="60" rx="3"/><rect class="o f-sun" x="468" y="318" width="26" height="26" rx="3"/><path class="o nf" d="M481 318v26M468 331h26"/>';
  s+='<path class="o f-brand" d="M-10 432C120 384 260 404 360 434C450 460 520 424 570 414L570 570L-10 570Z"/>';
  /* flowers */
  var fl=[[40,470],[150,520],[250,505],[330,530],[430,510],[530,470],[90,540]];
  fl.forEach(function(p,i){s+='<g class="sway" style="transform-origin:'+p[0]+'px '+(p[1]+14)+'px;animation-delay:'+(i*.3)+'s"><path class="o nf" d="M'+p[0]+' '+(p[1]+14)+'V'+p[1]+'"/><circle class="o '+(i%2?"f-sun":"f-blush")+'" cx="'+p[0]+'" cy="'+p[1]+'" r="7"/><circle class="f-clay" cx="'+p[0]+'" cy="'+p[1]+'" r="2.6"/></g>'});
  /* ladder */
  s+='<line class="t-o" x1="122" y1="300" x2="142" y2="486"/><line class="t-o" x1="152" y1="300" x2="172" y2="486"/>';
  [330,362,394,426,458].forEach(function(y,i){var x=122+(y-300)*20/186;s+='<line class="t-o" x1="'+x+'" y1="'+y+'" x2="'+(x+30)+'" y2="'+y+'"/>'});
  s+='<line class="t-f s-sun" x1="122" y1="300" x2="142" y2="486"/><line class="t-f s-sun" x1="152" y1="300" x2="172" y2="486"/>';
  [330,362,394,426,458].forEach(function(y){var x=122+(y-300)*20/186;s+='<line class="t-f s-sun" x1="'+x+'" y1="'+y+'" x2="'+(x+30)+'" y2="'+y+'"/>'});
  /* speaker */
  s+='<rect class="o f-clay" x="204" y="346" width="96" height="134" rx="18"/><circle class="o f-cream" cx="252" cy="376" r="13"/><circle class="f-ink" cx="252" cy="376" r="5"/><circle class="o f-cream" cx="252" cy="430" r="30"/><g class="pulse"><circle class="f-ink" cx="252" cy="430" r="19"/><circle class="f-cream" cx="252" cy="430" r="7"/></g>';
  s+='<g class="o nf" style="stroke-width:4.5"><path class="sw" d="M312 410q12 20 0 40"/><path class="sw" style="animation-delay:.3s" d="M328 398q18 32 0 64"/><path class="sw" style="animation-delay:.6s" d="M346 386q24 44 0 88"/></g>';
  /* mic on stand */
  s+='<g class="sway" style="transform-origin:392px 490px;animation-duration:4s"><line class="t-o" x1="392" y1="490" x2="392" y2="418"/><line class="t-f s-sage" x1="392" y1="490" x2="392" y2="418"/><g transform="rotate(-14 392 414)"><rect class="o f-sage" x="378" y="366" width="28" height="48" rx="14"/><path class="o nf" d="M378 384h28M378 394h28"/><rect class="o f-ink" x="383" y="410" width="18" height="10" rx="3"/></g></g><ellipse class="o f-ink" cx="392" cy="492" rx="28" ry="7"/>';
  /* people */
  s+=G.person(56,500,"f-blush","f-sun","s-sun","wave",0);
  s+=G.person(492,506,"f-sprout","f-clay","s-clay","gift",.4);
  /* floating hearts */
  s+='<g class="rise" style="animation-delay:0s">'+G.heart(94,300,1.1)+'</g><g class="rise" style="animation-delay:1.3s">'+G.heart(470,330,.9,"f-sun")+'</g><g class="rise" style="animation-delay:2.1s">'+G.heart(290,300,.8)+'</g>';
...
function onboarding(){
  ...
  if(s===0){
    ...
    '<div class="field"><label for="ob-street">Your street in Sutton Fields</label><select class="in" id="ob-street" data-in="me-street">'+(S.me.street?"":'<option value="" disabled selected>Choose your street</option>')+STREETS.map(function(x){return '<option'+(x===S.me.street?" selected":"")+'>'+x+'</option>'}).join("").replace('<option','<option',1)+'</select></div>'+
...
function listingCard(l,demo){
  ...
  return '<article class="card listing '+(l.kind==="need"?"need":"")+'"><div class="lh">'+ico(l.title+" "+l.body)+'<div class="grow"><p class="eyebrow">'+kindLabel+' &middot; '+esc(street)+'</p><h3>'+esc(l.title)+'</h3></div></div><p class="muted">'+esc(l.body)+'</p><div class="row wrapf">'+(l.kind==="need"?'<span class="chip need">Needs a hand</span>':"")+chips+'</div>'+
   '<div class="foot"><div class="who">'+av(who,"s")+'<div><b>'+esc(name)+(mine?'<span class="tag-you">You</span>':"")+'</b><span class="muted sm">'+l.when+'</span></div></div>'+cta+'</div></article>'
}
function postCard(p){
  ...
  '<div class="acts"><button class="btn sm heart-btn '+(liked?"need on":"quiet")+'" data-a="like" data-id="'+p.id+'" aria-pressed="'+!!liked+'">'+ICON.heart+(liked?"Thanked":"Say thanks")+' &middot; '+n+'</button>'+(mine?'<button class="btn sm quiet" data-a="del-post" data-id="'+p.id+'">Delete</button>':'<button class="btn sm quiet" data-a="msg" data-id="'+p.by+'" data-ref="your post">'+ICON.msg+'Reply</button>')+'</div></article>'
}
function shell(){
  return '<header class="topbar"><div class="wrap in-bar">'+wm()+
   ...
   '<div class="row"><button class="btn sm sun" data-a="inbox" aria-label="Messages">'+ICON.msg+'<span class="inbox-label">Messages</span><span class="badge" id="badge"'+(S.unread?"":" hidden")+'>'+S.unread+'</span></button>'+av(S.me,"s")+'<button class="btn sm quiet" data-a="logout">Log out</button></div></div></header>'+
...
/* ---------- modals ---------- */
function modal(html){$("#modal").innerHTML='<div class="scrim" data-a="scrim"><div class="modal" role="dialog" aria-modal="true">'+html+'</div></div>';var f=$("#modal input,#modal textarea,#modal button.btn");if(f)f.focus()}
...
function profileModal(){
  var m=S.me;
  modal('<h2>Edit profile</h2><div class="field"><label for="pn">Name</label><input class="in" id="pn" value="'+esc(m.name)+'"></div>'+
   '<div class="field"><label for="ps">Street</label><select class="in" id="ps">'+STREETS.map(function(x){return '<option'+(x===m.street?" selected":"")+'>'+x+'</option>'}).join("")+'</select></div>'+
